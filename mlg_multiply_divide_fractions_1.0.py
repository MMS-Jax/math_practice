# Mya G., Multiply & Divide Fractions, 05/06/19, version 1.0

print('Hello, I am Ducky Momo! I can mulitply and divide fractions for you.\n')
print('To multiply and divide fractions, I need to know the numerator and denominator for each fraction.\n')
