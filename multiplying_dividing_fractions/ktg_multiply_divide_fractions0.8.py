# Gardner K., Multiplying and Dividing Fractions ,05/06/2019, version 0.8

print("Hello, welcome to Radical Mathmatical Calculator.  I can multiply and divide fractions for you!\n")
...
print("When dividing fractions you need to flip the second fraction so that the denominator becomes the numerator.\n")
print("Then you will multiply the two new numerators together.\n")
print("Then you will multiply the two new denominators together.\n")
...
new_numerator =  numerator0 / denominator0
new_denominator = denominator1 / numerator1
