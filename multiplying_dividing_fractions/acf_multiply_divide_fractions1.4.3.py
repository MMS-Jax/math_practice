...
#Numerators
numerator1 = input("Type a Number to be your 1st numerator, then hit Enter")
numerator2 = input("Type a Number to be your 2nd numerator, then hit Enter")
#Denominators
denominator1 = input("Type a Number to be your 1st denominator, then hit Enter")
denominator2 = input("Type a Number to be your 2nd denominator, then hit Enter")
#fractions
