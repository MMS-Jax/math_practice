# Benjamin Hadziabdic, Multiplying and Dividing Fractions, 05/20/2019, Version 0.6
...
denominator0 = int(input('and the second denominator is...? type your number and hit ENTER\n'))
