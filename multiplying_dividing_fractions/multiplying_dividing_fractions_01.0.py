# Tyler A. , Multiplying and Dividing Fractions, 05/06/2019, version 1.0
...
print("To divide a fraction, you will using the reciprocal or inverse of the second fraction.\n")
