# Kailey D., Multiplying and Dividing Fractions, 05/06/2019, version 1.0
...
print("To find the answer we are going to need to know the numerator and the denominator for both fractions.\n")
...
print("Whenever you divide fractions, you multiply the Numerator of the first fraction by the Denominator of the second fraction.\n")
print("Next you multiply the Denominator of the first fraction by the Numerator of the second fraction.\n")

numerator0 = int(input("Type the first numerator then press enter.\n"))
numerator1 = int(input("Type the second numerator then press enter.\n"))

denominator0 = int(input("Type the fist denominator then press enter.\n"))
denominator1 = int(input("Type the second denominator then press enter.\n"))
