# Zayne D. Program will Multiply and Divide Fractions, 5/09/2019, Version 0.8
...
print('Now to divide a fraction, you will multiply using the reciprocal or inverse of the second fraction. \n')
