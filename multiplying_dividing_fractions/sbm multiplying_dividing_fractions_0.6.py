# Sasha M., Multiplying and Dividing Fractions, 05/10/2019, version 0.2
...
print("For this , i will need to now the denominator and numerator of both the fractions.\n")
