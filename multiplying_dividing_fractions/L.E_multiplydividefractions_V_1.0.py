# Multiplying/Dividing Fraction Calculator by Logan E. | Version 1.0 
...
import time
time.sleep(2)  # Delay end v 0.2 for 2 seconds

print("Thank you for using my multiplying and dividing fraction calculator.\n")

#Yes/No Input Here V.E.0.2
answer = input("Did you enjoy this calculator?\n").upper()
if answer == "YES":
