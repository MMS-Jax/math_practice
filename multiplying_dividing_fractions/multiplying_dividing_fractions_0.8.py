# Ryan K., Multiplying and Dividing Fractions, 05/10/2019, version 0.8
...
numerator0 = int(input(" 4.\n")) 
numerator1 = int(input(" 6.\n"))
...
print("Then you have to do the same with the other numerator and the 1st fraction's denominator.\n")
