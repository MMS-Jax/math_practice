# Brendan D. , Multiplying and Dividing Fractions, 05/06/2019, version 1.0

print("Hello! My name is Engamespoiler-9000, here to help you multiply and divide fractions.\n")
...
print("When dividing fractions you multiply using the reciprocal or inverse of the second fraction.\n")
