# Sergey R., Multiplying and Dividing Fractions, 05/10/2019 version 1.0
...
print("Now You will learn how to divide fractions.\n")
...
new_numerator1 = denominator3 * numerator2
