# Ryan K., Slope-Intercept Ordered Pair Solver, 05/10/2019, v0.0
...
time.sleep(5) # This is a METHOD that pauses the program for the number of seconds indicated.  Change this to 10.
